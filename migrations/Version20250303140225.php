 ...
 */
final class Version20250303140225 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE itineraire_lieu (itineraire_id INT NOT NULL, lieu_id INT NOT NULL, INDEX IDX_9844E6896AB213CC (lieu_id), INDEX IDX_9844E689A9B853B8 (itineraire_id), PRIMARY KEY(itineraire_id, lieu_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('ALTER TABLE itineraire_lieu ADD CONSTRAINT FK_9844E6896AB213CC FOREIGN KEY (lieu_id) REFERENCES lieu (id) ON UPDATE NO ACTION ON DELETE CASCADE');
        $this->addSql('ALTER TABLE itineraire_lieu ADD CONSTRAINT FK_9844E689A9B853B8 FOREIGN KEY (itineraire_id) REFERENCES itineraire (id) ON UPDATE NO ACTION ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE avis ADD CONSTRAINT FK_8F91ABF0197E709F FOREIGN KEY (avis_id) REFERENCES itineraire (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
